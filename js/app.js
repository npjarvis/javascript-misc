 ...
 */
// strict mode helps avoid mis-spelling, instead of creating a new mis-spelled variable it will tell us we mis-spelled
"use strict";
...
function onReady() {
    ...
    var exitButton = document.getElementById('exit-button'); // 'exit-button' is in html.index, then must addEventListener
    // just pass function w/o name, put function in-line
    // window object is used to re-direct web page
    exitButton.addEventListener('click', function() {
        // window.confirm gives user a confirm or deny option and returns true or false respectively
        if (window.confirm('Are you realllllllly sure you want to leave? I worked my butt off for this!')){
    ...
    // javascript DOM events, remove 'on' in front of events because its only for html
} //onReady()
...
function calculateAge(dob) {
    // if dob is empty string or null string it is false, otherwise its true
    if (!dob) {
    ...
    var daysDiff = today.getDay() - dob.getUTCDay();
